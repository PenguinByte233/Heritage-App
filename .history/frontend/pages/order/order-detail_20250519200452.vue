        ...
        <scroll-view class="content" scroll-y enable-back-to-top>
          ...
          <view class="footer-actions">
            ...
            <view class="swipe-hint" v-if="allOrders.length > 1">
              ...
              <view class="order-indicator">
                <text class="indicator-text">订单 {{ index + 1 }}/{{ allOrders.length }}</text>
              </view>
            </view>
          </view>
        </scroll-view>
      ...
      uni.request({
        ...
        success: (res) => {
          ...
          if (res.data && res.data.status === 'success') {
            ...
            console.log(`用户ID ${userId} 的所有订单列表:`, orderList);
...
.order-swiper {
  ...
  width: 100%;
  height: 92vh !important; /* 使用视窗高度单位 */
}
