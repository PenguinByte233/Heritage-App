  ...
  <view class="container">
    ...
    <view class="post-list">
      ...
      >
        ...
        <button class="enter-detail-btn" @tap="navigateToDetail(post)">查看详情</button>
      </view>
    ...
    <view class="post-form-overlay" v-if="showForm" @tap="hidePostForm">
      <view class="post-form" @tap.stop>
        ...
        <view class="user-info-preview">
          <image class="avatar-small" :src="userInfo.avatar_url || '/static/images/default-avatar.png'"></image>
      ...
      try {
        ...
        if (response.status === 'success' && response.data) {
          this.posts = response.data.map(post => {
            // 添加默认头像
            if (!post.avatar_url) {
              post.avatar_url = '/static/images/default-avatar.png';
            }
            return post;
          });
        } else {
