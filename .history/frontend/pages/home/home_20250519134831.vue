<template>
  <view class="container">
    ...
    <view class="map-section">
      ...
      <!-- 非遗装饰图片区域 -->
      <view class="heritage-showcase">
        <view class="heritage-item" @tap="navigateToLearnCategory(heritageItems[0])">
          <image class="heritage-image" src="/static/images/Home/Home/非遗/非遗1.jpg" mode="aspectFill"></image>
          <view class="heritage-label">传统技艺</view>
        </view>
        <view class="heritage-item-double">
          <view class="heritage-item small" @tap="navigateToLearnCategory(heritageItems[1])">
            <image class="heritage-image" src="/static/images/Home/Home/非遗/非遗2.jpg" mode="aspectFill"></image>
            <view class="heritage-label">传统美术</view>
          </view>
          <view class="heritage-item small" @tap="navigateToLearnCategory(heritageItems[2])">
            <image class="heritage-image" src="/static/images/Home/Home/非遗/非遗.jpg" mode="aspectFill"></image>
            <view class="heritage-label">传统医药</view>
          </view>
        </view>
      </view>
    </view>
...
export default {
  data() {
    return {
      ...
      bannerImages: [
        '/static/images/Home/Carousel/常山战鼓2.jpg',
      ...
      heritageItems: [
        {
          title: '传统技艺',
          description: '包括各种手工艺和传统制作技术'
        },
        {
          title: '传统美术',
          description: '包括绘画、雕塑、剪纸等传统美术形式'
        },
        {
          title: '传统医药',
          description: '包括中医、藏医、蒙医等传统医药知识'
        }
      ]
    }
  },
...
.heritage-item.small:last-child {
  margin-bottom: 0;
}
