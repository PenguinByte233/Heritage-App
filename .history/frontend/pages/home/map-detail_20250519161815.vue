      ...
      <block v-else>
        ...
        <view class="map-container">
          <swiper class="map-swiper" indicator-dots indicator-active-color="#6d4126" indicator-color="rgba(255, 255, 255, 0.6)">
            <swiper-item v-for="(url, index) in mapImages" :key="index">
              <image class="map-image" :src="url" mode="widthFix" @tap="previewImage(url)"></image>
            </swiper-item>
          </swiper>
        ...
        <view class="stats-section">
          ...
          <view class="stats-cards">
            <view class="stats-card">
              <text class="stats-number">{{ statistics.world }}</text>
              <text class="stats-label">世界级非遗</text>
              <text class="stats-desc">联合国教科文组织认定</text>
            </view>
            
            <view class="stats-card">
              <text class="stats-number">{{ statistics.national }}</text>
              <text class="stats-label">国家级非遗</text>
              <text class="stats-desc">国家文化和旅游部认定</text>
            </view>
            
            <view class="stats-card">
              <text class="stats-number">{{ statistics.provincial }}</text>
...
<script>
import { getMapResources, processImageUrl } from '@/api/api.js';
