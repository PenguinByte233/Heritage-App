      ...
      <view class="content-details">
        ...
        <view class="article-container">
          ...
          <view class="paragraph">
            <text class="paragraph-text">{{tutorialData.content[0]}}</text>
          </view>
          
          <!-- 第一张内容图片 -->
          <view class="content-image-container">
            <image :src="tutorialData.images[1]" mode="widthFix" class="content-image"></image>
            <text class="image-caption">常山战鼓表演现场</text>
          </view>
          
          <!-- 第二段文字 -->
          <view class="paragraph">
            <text class="paragraph-text">{{tutorialData.content[1]}}</text>
          </view>
          
          <!-- 第二张内容图片 -->
          <view class="content-image-container">
            <image :src="tutorialData.images[2]" mode="widthFix" class="content-image"></image>
            <text class="image-caption">常山战鼓表演队伍</text>
          </view>
          
          <!-- 第三段文字 -->
          <view class="paragraph">
            <text class="paragraph-text">{{tutorialData.content[2]}}</text>
          </view>
          
          <!-- 第三张内容图片 -->
          <view class="content-image-container">
            <image :src="tutorialData.images[3]" mode="widthFix" class="content-image"></image>
            <text class="image-caption">常山战鼓传承人</text>
          </view>
          
          <!-- 第四段文字 -->
          <view class="paragraph">
            <text class="paragraph-text">{{tutorialData.content[3]}}</text>
          </view>
        </view>
      </view>
