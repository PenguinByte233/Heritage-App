...
async function insertLearning(connection) {
  ...
  const learningData = [
    ...
    },
    {
      title: '传统艺术与工艺',
      subtitle: '剪纸',
      image_url: '/uploads/assets/传统艺术与工艺/剪纸/海伦剪纸1.jpg',
      all_images: '/uploads/assets/传统艺术与工艺/剪纸/海伦剪纸1.jpg\t/uploads/assets/传统艺术与工艺/剪纸/海伦剪纸2.jpg\t/uploads/assets/传统艺术与工艺/剪纸/海伦剪纸3.jpg',
      content_url: '/uploads/assets/传统艺术与工艺/剪纸/海伦剪纸.txt',
      all_content_urls: '/uploads/assets/传统艺术与工艺/剪纸/海伦剪纸.txt',
      created_at: new Date('2025-05-18 14:19:58')
    },
    {
      title: '传统艺术与工艺',
      subtitle: '唐卡',
      image_url: '/uploads/assets/传统艺术与工艺/唐卡/藏族唐卡1.jpg',
      all_images: '/uploads/assets/传统艺术与工艺/唐卡/藏族唐卡1.jpg\t/uploads/assets/传统艺术与工艺/唐卡/藏族唐卡2.jpg\t/uploads/assets/传统艺术与工艺/唐卡/藏族唐卡3.jpg\t/uploads/assets/传统艺术与工艺/唐卡/藏族唐卡4.jpg',
      content_url: '/uploads/assets/传统艺术与工艺/唐卡/藏族唐卡.txt',
      all_content_urls: '/uploads/assets/传统艺术与工艺/唐卡/藏族唐卡.txt',
      created_at: new Date('2025-05-18 14:19:58')
    },
    {
      title: '传统表演艺术',
    ...
    },
    {
      title: '传统节日与庆典',
      subtitle: '龙舟',
      image_url: '/uploads/assets/传统节日与庆典/龙舟/龙舟1.jpg',
      all_images: '/uploads/assets/传统节日与庆典/龙舟/龙舟1.jpg\t/uploads/assets/传统节日与庆典/龙舟/龙舟2.jpg\t/uploads/assets/传统节日与庆典/龙舟/龙舟3.jpg',
      content_url: '/uploads/assets/传统节日与庆典/龙舟/龙舟.txt',
      all_content_urls: '/uploads/assets/传统节日与庆典/龙舟/龙舟.txt',
      created_at: new Date('2025-05-18 14:19:58')
    },
    {
      title: '传统装饰与配饰',
      subtitle: '簪花',
      image_url: '/uploads/assets/传统装饰与配饰/簪花/三条簪1.jpg',
      all_images: '/uploads/assets/传统装饰与配饰/簪花/三条簪1.jpg\t/uploads/assets/传统装饰与配饰/簪花/三条簪2.jpg\t/uploads/assets/传统装饰与配饰/簪花/三条簪3.jpg',
      content_url: '/uploads/assets/传统装饰与配饰/簪花/三条簪.txt',
      all_content_urls: '/uploads/assets/传统装饰与配饰/簪花/三条簪.txt',
      created_at: new Date('2025-05-18 14:19:58')
    },
    {
      title: '文化与创意产业',
      subtitle: '文创图片',
      image_url: '/uploads/assets/文化与创意产业/图片1.png',
      all_images: '/uploads/assets/文化与创意产业/图片1.png\t/uploads/assets/文化与创意产业/图片2.png\t/uploads/assets/文化与创意产业/图片3.png',
      content_url: '/uploads/assets/文化与创意产业/文创图片.txt',
      all_content_urls: '/uploads/assets/文化与创意产业/文创图片.txt',
      created_at: new Date('2025-05-18 14:19:58')
    }
  ];
...
async function insertProducts(connection) {
  ...
  const products = [
    {
      ...
      price: 304.42,
      description: '竹编包包是非物质文化遗产中的精品，手工编织而成。这款包包选用优质竹材，经过传统工艺精心编织。特点：1. 纯手工编织，每一件都是独特的；2. 轻便耐用，环保材质；3. 通风透气，适合四季使用；4. 传统与现代结合的设计，既实用又美观',
    ...
    },
    {
      ...
      price: 356.23,
      description: '竹编扇子是我国传统工艺品，历史悠久，工艺精湛。这款扇子由经验丰富的竹编艺人手工制作，造型典雅，做工精细。特点：1. 采用优质竹材，轻便耐用；2. 手工精编，纹理清晰，做工考究；3. 散热效果好，使用舒适；4. 既可用于日常消暑，又可作为收藏品或礼品',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编扇子',
    ...
    },
    {
      ...
      price: 371.09,
      description: '竹编椅子是中国传统家具中的精品，代表着非物质文化遗产中的竹编工艺。这款椅子采用优质竹材，由经验丰富的竹编艺人手工制作而成。特点：1. 选用优质竹材，经过防腐、防虫处理，耐用性强；2. 纯手工编织，每一件都独具匠心；3. 结构牢固，可承受较大重量；4. 造型美观，既有传统韵味，又符合现代审美；5. 透气性好，坐感舒适，适合四季使用',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编椅子',
    ...
    },
    {
      name: '竹编椅子',
      category: '竹编',
      image_url: '/uploads/assets/商品/卖竹编椅子3.jpg',
      price: 416.73,
      description: '竹编椅子是中国传统家具中的精品，代表着非物质文化遗产中的竹编工艺。这款椅子采用优质竹材，由经验丰富的竹编艺人手工制作而成。特点：1. 选用优质竹材，经过防腐、防虫处理，耐用性强；2. 纯手工编织，每一件都独具匠心；3. 结构牢固，可承受较大重量；4. 造型美观，既有传统韵味，又符合现代审美；5. 透气性好，坐感舒适，适合四季使用',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编灯罩',
      category: '竹编',
      image_url: '/uploads/assets/商品/卖竹编灯罩1.jpg',
      price: 308.32,
      description: '竹编灯罩是传统竹编工艺的现代应用，既实用又美观。这款灯罩采用精选竹材，经过传统工艺编织而成。特点：1. 手工精编，每一件都独具特色；2. 通透性好，光线柔和；3. 具有良好的透气性和散热性；4. 传统与现代结合，适合各种家居风格',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编灯罩',
      category: '竹编',
      image_url: '/uploads/assets/商品/卖竹编灯罩2.jpg',
      price: 93.70,
      description: '竹编灯罩是传统竹编工艺的现代应用，既实用又美观。这款灯罩采用精选竹材，经过传统工艺编织而成。特点：1. 手工精编，每一件都独具特色；2. 通透性好，光线柔和；3. 具有良好的透气性和散热性；4. 传统与现代结合，适合各种家居风格',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编灯罩',
      category: '竹编',
      image_url: '/uploads/assets/商品/卖竹编灯罩3.jpg',
      price: 161.67,
      description: '竹编灯罩是传统竹编工艺的现代应用，既实用又美观。这款灯罩采用精选竹材，经过传统工艺编织而成。特点：1. 手工精编，每一件都独具特色；2. 通透性好，光线柔和；3. 具有良好的透气性和散热性；4. 传统与现代结合，适合各种家居风格',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编篮',
      category: '竹编',
      image_url: '/uploads/assets/商品/卖竹编篮1.jpg',
      price: 118.40,
      description: '竹编篮是传统竹编工艺的代表作品，实用性强。这款竹篮采用优质竹材，经过传统工艺精心编织。特点：1. 轻便耐用，承重能力强；2. 透气性好，适合存放水果等食物；3. 纯手工编织，每一件都是独特的；4. 美观实用，既可用于日常生活，又可作为装饰品',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编篮',
      category: '竹编',
      image_url: '/uploads/assets/商品/卖竹编篮2.jpg',
      price: 115.83,
      description: '竹编篮是传统竹编工艺的代表作品，实用性强。这款竹篮采用优质竹材，经过传统工艺精心编织。特点：1. 轻便耐用，承重能力强；2. 透气性好，适合存放水果等食物；3. 纯手工编织，每一件都是独特的；4. 美观实用，既可用于日常生活，又可作为装饰品',
      created_at: new Date('2025-05-18 20:13:47')
    },
    {
      name: '竹编篮',
      category: '竹编',
      image_url: '/uploads/assets/商品/卖竹编篮3.jpg',
      price: 465.10,
      description: '竹编篮是传统竹编工艺的代表作品，实用性强。这款竹篮采用优质竹材，经过传统工艺精心编织。特点：1. 轻便耐用，承重能力强；2. 透气性好，适合存放水果等食物；3. 纯手工编织，每一件都是独特的；4. 美观实用，既可用于日常生活，又可作为装饰品',
      created_at: new Date('2025-05-18 20:13:47')
    }
  ...
  // 批量插入商品数据
  const [result] = await connection.query(
    'INSERT INTO products (name, category, image_url, price, description, created_at) VALUES ?',
